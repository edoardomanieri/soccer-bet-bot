...
def get_live_predictions(reprocess_train_data=False,
    ...
    input_result_prematch_odds = result_utils.pop_input_prematch_odds_data(input_result_df)
    input_result_live_odds = result_utils.pop_input_live_odds_data(input_result_df)
    ...
    predictions_result_df = result_utils.get_prior_posterior_predictions(predictions_result_df, input_result_prematch_odds)
