...
def get_live_predictions(reprocess_train_data=False,
    ...
    input_goals_df = goals_utils.normalize_prematch_odds(input_goals_df)
    input_goals_prematch_odds = goals_utils.pop_input_prematch_odds_data(input_goals_df)
    input_goals_live_odds = goals_utils.pop_input_live_odds_data(input_goals_df)
    ...
    predictions_goals_df = goals_utils.get_prior_posterior_predictions(predictions_goals_df, input_goals_prematch_odds)
